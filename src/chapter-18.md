...
- 当前章无独立代码目录；建议结合 [Chapter 32](./chapter-32.md) 和各案例 dApp 阅读。
...
1. 先读架构总览
2. 再和 [Chapter 32](./chapter-32.md) 的脚手架代码结合
3. 最后回到具体案例 dApp 看状态管理落地

## 验证步骤

1. 能画出前端、索引层、钱包、链上对象的分层关系
2. 能说明哪些状态适合放 Query、哪些适合本地状态
3. 能为自己的 dApp 划分模块边界

## 常见报错

- 把钱包连接、查询逻辑和页面展示全耦合在一个组件中
