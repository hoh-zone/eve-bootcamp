...
function App() {
  ...
  const handleAction = async () => {
    ...
    // Dummy transaction representing the smart contract call for Example 4
    tx.moveCall({
      target: `0x123::example_04::complete_quest`,
      arguments: [],
    });
  ...
  return (
    <Box style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
      <Flex justify="between" align="center" mb="6">
        <Heading>Example 4: 任务解锁系统 (Quests)</Heading>
        <Button 
          size="3" 
          variant="soft" 
      ...
      {account ? (
        <Card size="4" style={{ marginTop: "20px" }}>
          ...
          <Text as="p" mb="4" color="gray">
            This dApp provides a frontend interface for the 任务解锁系统 (Quests) mechanics.
          </Text>
