...
function App() {
  ...
  const handleAction = async () => {
    ...
    // Dummy transaction representing the smart contract call for Example 12
    tx.moveCall({
      target: `0x123::example_12::apply`,
      arguments: [],
    });
  ...
  return (
    <Box style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
      <Flex justify="between" align="center" mb="6">
        <Heading>Example 12: 联盟招募 (Recruitment)</Heading>
        <Button 
          size="3" 
          variant="soft" 
      ...
      {account ? (
        <Card size="4" style={{ marginTop: "20px" }}>
          ...
          <Text as="p" mb="4" color="gray">
            This dApp provides a frontend interface for the 联盟招募 (Recruitment) mechanics.
          </Text>
