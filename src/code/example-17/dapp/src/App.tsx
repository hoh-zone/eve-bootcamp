...
function App() {
  ...
  const handleAction = async () => {
    ...
    // Dummy transaction representing the smart contract call for Example 17
    tx.moveCall({
      target: `0x123::example_17::sign_action`,
      arguments: [],
    });
  ...
  return (
    <Box style={{ padding: "20px", maxWidth: "800px", margin: "0 auto" }}>
      <Flex justify="between" align="center" mb="6">
        <Heading>Example 17: 游戏内浮层实战 (In-game Overlay)</Heading>
        <Button 
          size="3" 
          variant="soft" 
      ...
      {account ? (
        <Card size="4" style={{ marginTop: "20px" }}>
          ...
          <Text as="p" mb="4" color="gray">
            This dApp provides a frontend interface for the 游戏内浮层实战 (In-game Overlay) mechanics.
          </Text>
          <Button size="3" onClick={handleAction}>
            Sign Action in Overlay
          </Button>
        </Card>
      ) : (
