...
| Chapter 2  | [chapter-02.md](./chapter-02.md) | 开发环境配置：Sui CLI、EVE Vault、测试资产获取与最小验收 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 6 | [chapter-06.md](./chapter-06.md) | Builder Scaffold 入口：项目结构、smart_gate 架构、编译与发布 |
| Chapter 7 | [chapter-07.md](./chapter-07.md) | TS 脚本与前端：helper.ts、脚本链路、React dApp 模板 |
| Chapter 8 | [chapter-08.md](./chapter-08.md) | 服务端协同：Sponsored Tx、AdminACL、链上链下配合 |
| Chapter 9 | [chapter-09.md](./chapter-09.md) | 数据读取：GraphQL、事件订阅、索引器思路 |
| Chapter 10 | [chapter-10.md](./chapter-10.md) | dApp 钱包接入：useConnection、赞助交易、Epoch 处理 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 11  | [chapter-11.md](./chapter-11.md) | 所有权模型深度解析：OwnerCap、Keychain、Borrow-Use-Return、委托 |
| Chapter 12  | [chapter-12.md](./chapter-12.md) | Move 进阶：泛型、动态字段、事件系统、Table 与 VecMap |
| Chapter 13 | [chapter-13.md](./chapter-13.md) | NFT 设计与元数据管理：Display 标准、动态 NFT、Collection 模式 |
| Chapter 14  | [chapter-14.md](./chapter-14.md) | 链上经济系统设计：代币发行、去中心化市场、动态定价、金库 |
| Chapter 15 | [chapter-15.md](./chapter-15.md) | 跨合约组合性：调用其他 Builder 的合约、接口设计、协议标准 |
| Chapter 16 | [chapter-16.md](./chapter-16.md) | 位置与临近性系统：哈希位置、临近证明、地理策略设计 |
| Chapter 17 | [chapter-17.md](./chapter-17.md) | 测试、调试与安全审计：Move 单元测试、漏洞类型、升级策略 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 18 | [chapter-18.md](./chapter-18.md) | 多租户与游戏服务器集成：Tenant 模型、ObjectRegistry、服务端脚本 |
| Chapter 19 | [chapter-19.md](./chapter-19.md) | 全栈 dApp 架构设计：状态管理、实时更新、多链支持、CI/CD |
| Chapter 20 | [chapter-20.md](./chapter-20.md) | 游戏内接入：浮层 UI、postMessage、游戏事件桥接 |
| Chapter 21 | [chapter-21.md](./chapter-21.md) | 性能优化与 Gas 最小化：事务批处理、读写分离、链下计算 |
| Chapter 22 | [chapter-22.md](./chapter-22.md) | Move 高级模式：升级兼容设计、动态字段扩展、数据迁移 |
| Chapter 23 | [chapter-23.md](./chapter-23.md) | 发布、维护与社区协作：主网部署、Package 升级、Builder 协作 |
| Chapter 24 | [chapter-24.md](./chapter-24.md) | 故障排查手册：常见 Move/Sui/dApp 错误类型与系统化调试方法 |
| Chapter 25 | [chapter-25.md](./chapter-25.md) | 从 Builder 到产品：商业模式、用户增长、社区运营、渐进去中心化 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 26 | [chapter-26.md](./chapter-26.md) | **访问控制完整解析**：GovernorCap / AdminACL / OwnerCap / Receiving 模式 |
| Chapter 27 | [chapter-27.md](./chapter-27.md) | **链下签名 × 链上验证**：Ed25519、PersonalMessage intent、sig_verify 精读 |
| Chapter 28 | [chapter-28.md](./chapter-28.md) | **位置证明协议**：LocationProof、BCS 反序列化、临近性验证实战 |
| Chapter 29 | [chapter-29.md](./chapter-29.md) | **能量与燃料系统**：EnergySource、Fuel 消耗率计算、已知 Bug 分析 |
| Chapter 30 | [chapter-30.md](./chapter-30.md) | **Extension 模式实战**：官方 tribe_permit + corpse_gate_bounty 精读 |
| Chapter 31 | [chapter-31.md](./chapter-31.md) | **炮塔 AI 扩展**：TargetCandidate、优先级队列、自定义 AI 开发 |
| Chapter 32 | [chapter-32.md](./chapter-32.md) | **KillMail 系统**：PvP 击杀记录、TenantItemId、derived_object 防重放 |
...
| Chapter 35 | [chapter-35.md](./chapter-35.md) | **未来展望**：零知识证明、完全去中心化游戏、EVM 互操作 |
