...
| Chapter 9  | [chapter-09.md](./chapter-09.md) | 测试、调试与安全审计：Move 单元测试、漏洞类型、升级策略 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 11 | [chapter-11.md](./chapter-11.md) | 赞助交易与服务端集成：Sponsored Tx、AdminACL、链上链下协同 |
| Chapter 12 | [chapter-12.md](./chapter-12.md) | 链下索引与 GraphQL 进阶：自定义索引器、实时订阅、数据聚合 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 21 | [chapter-21.md](./chapter-21.md) | 游戏内 dApp 集成：浮层 UI、游戏事件监听、postMessage 桥接 |
...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 31 | [chapter-31.md](./chapter-31.md) | **项目结构与合约开发**：Docker 环境、smart_gate 三文件架构、编译与发布 |
| Chapter 32 | [chapter-32.md](./chapter-32.md) | **TS 脚本与 dApp 开发**：6 个交互脚本、helper.ts 工具链、React Hooks、赞助交易 |
...
| Chapter 35 | [chapter-35.md](./chapter-35.md) | **dApp 集成实战**：useConnection、赞助交易、Epoch 刷新、hasEveVault 检测 |
