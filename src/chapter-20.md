...
- 建议先读 [Chapter 15](./chapter-15.md)
- 建议先读 [Chapter 19](./chapter-19.md)

## 源码位置

- [book/src/code/chapter-20](./code/chapter-20)

## 关键测试文件

- 当前目录以概念片段为主；重点是架构演进判断。

## 推荐阅读顺序

1. 先回顾当前中心化假设
2. 再阅读 ZK、完全去中心化与互操作方向
3. 最后评估哪些设计需要今天就留接口

## 验证步骤

1. 能指出全书里哪些地方依赖中心化服务器
2. 能判断哪些接口值得为未来 ZK/跨链预留
3. 能把“未来方向”转成今天的工程约束

## 常见报错

- 把展望章节当作纯愿景，不回扣当前架构的可迁移性
