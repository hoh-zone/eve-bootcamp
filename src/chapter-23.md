...
- 建议先读 [Chapter 10](./chapter-10.md)
- 建议先读 [Chapter 18](./chapter-18.md)
- 建议先读 [Chapter 22](./chapter-22.md)

## 源码位置

- [book/src/code/chapter-23](./code/chapter-23)

## 关键测试文件

- 当前目录以产品化片段为主；重点在指标与经营模型。

## 推荐阅读顺序

1. 先读四种商业模式
2. 再回看本书案例分别属于哪一类产品路径
3. 最后把技术实现和收入模型配平

## 验证步骤

1. 能为至少一个案例补出用户路径、收费点和留存动作
2. 能识别“有技术没产品”的断层在哪里
3. 能把本章内容和 Chapter 10 的发布维护串起来

## 常见报错

- 只讲商业化想象，不把收入来源、运营动作和链上机制对应起来
