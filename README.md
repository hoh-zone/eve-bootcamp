...
| 章节 | 文件 | 主题摘要 |
|------|------|--------|
| Chapter 31 | [chapter-31.md](./src/chapter-31.md) | Builder Scaffold 入口：项目结构、smart_gate 架构、编译与发布 |
| Chapter 32 | [chapter-32.md](./src/chapter-32.md) | TS 脚本与前端：helper.ts、脚本链路、React dApp 模板 |
| Chapter 11 | [chapter-11.md](./src/chapter-11.md) | 服务端协同：Sponsored Tx、AdminACL、链上链下配合 |
| Chapter 12 | [chapter-12.md](./src/chapter-12.md) | 数据读取：GraphQL、事件订阅、索引器思路 |
| Chapter 35 | [chapter-35.md](./src/chapter-35.md) | dApp 钱包接入：useConnection、赞助交易、Epoch 处理 |
...
| Chapter 21 | [chapter-21.md](./src/chapter-21.md) | 游戏内接入：浮层 UI、postMessage、游戏事件桥接 |
